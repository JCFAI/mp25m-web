...
export default async function ArticulationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [supabase, opportunityDetail, assigneeOptions] = await Promise.all([
    createClient(),
