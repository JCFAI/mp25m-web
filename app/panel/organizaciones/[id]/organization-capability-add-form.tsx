...
import {
  ...
  proposeOrganizationCapabilitySkillAction,
...
export function OrganizationCapabilityAddForm({
  ...
  const [
    ...
    proposeOrganizationCapabilitySkillAction.bind(
      null,
      organizationId
    ),
    initialState
    ...
    >
      ...
      {!selectedSkill ? (
        <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm leading-6 text-slate-600">
          Seleccioná una capacidad existente para completar alcance,
          observaciones y evidencia. Si no existe, podés proponerla
          para revisión del catálogo.
        </div>
      ) : null}
