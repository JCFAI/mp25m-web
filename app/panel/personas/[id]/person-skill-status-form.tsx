...
import {
  confirmPersonSkillAction,
  deactivatePersonSkillAction,
  rejectPersonSkillAction,
  type PersonSkillActionState,
} from './actions'

type PersonSkillStatusAction =
  | 'confirm'
  | 'reject'
  | 'deactivate'
...
function actionForType(actionType: PersonSkillStatusAction) {
  if (actionType === 'confirm') {
    return confirmPersonSkillAction
  }

  if (actionType === 'reject') {
    return rejectPersonSkillAction
  }

  return deactivatePersonSkillAction
}

export function PersonSkillStatusForm({
  personId,
  personSkillId,
  skillId,
  actionType,
  ...
  skillId: string
  actionType: PersonSkillStatusAction
}) {
